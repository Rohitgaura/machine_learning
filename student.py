...
print(data)from tkinter import* 
...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","CSE","CIVIL","MECH","EEE","AI")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","BTECH","MTECH","BE","BSC","MSC")
        cou_combo.current(0)
...
# ==================Function Decleration==============================
    ...
    def get_cursor(self,event=""):
        ...
        # "UPDATE student SET std_name=%s, dep=%s, course=%s, year=%s, semester=%s, div=%s, gender=%s, dob=%s, mob=%s, address=%s, roll=%s, email=%s, teacher=%s, photosample=%s WHERE std_id=%s"
    # ========================================Update Function==========================
    ...
    #                 mycursor = conn.cursor()
    #                 sql_query = "UPDATE student SET std_name=%s, dep=%s, course=%s, year=%s, semester=%s, div=%s, gender=%s, dob=%s, mob=%s, address=%s, roll=%s, email=%s, teacher=%s, photosample=%s WHERE std_id=%s"
    #                 values = (
    #                     self.var_std_name.get(),
    #                     self.var_dep.get(),
    #                     self.var_course.get(),
            ...
            try:
                ...
                if Update > 0:
                    ...
                    mycursor.execute("""UPDATE
                                            student
                                        SET
                                            std_name=%s, dep=%s, course=%s, year=%s, semester=%s, division=%s, gender=%s, dob=%s, mob=%s, address=%s, roll=%s, email=%s, teacher=%s, photosample=%s
                                        WHERE
                                            std_id=%s""",( 
                    self.var_std_name.get(),
                    self.var_dep.get(),
    ...
    def search_data(self):
        if self.var_search.get()=="" or self.var_searchTX.get()=="Select":
            ...
            try:
                ...
                sql = "SELECT std_id, std_name, dep, course, year, semester, division, gender, dob, mob, address, roll, email, teacher, photosample FROM student where roll='" +str(self.var_search.get()) + "'" 
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                mycursor.execute("UPDATE student SET std_name=%s, dep=%s, course=%s, year=%s, semester=%s, division=%s, gender=%s, dob=%s, mob=%s, address=%s, roll=%s, email=%s, teacher=%s, photosample=%s where std_id=%s",(
                    self.var_std_name.get(),
                    self.var_dep.get(),
                    self.var_course.get(),
                    self.var_year.get(),
